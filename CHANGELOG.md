...
- Ship a built GitHub package with checksums and fresh verification.
- Update CLI and plugin metadata and GitHub installation instructions.
- Preserve 0.5.1 inventory, analysis and safe-export behavior.
- Align npm, GitHub, CLI and plugin versions at 0.5.2.

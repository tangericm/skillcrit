...
The archive contains built JavaScript; GitHub's automatic source archives do not.
Installing dependencies still requires npm access or a populated local cache.
...
[release verification guide](verification.md). No external participants

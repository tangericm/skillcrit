...
The 0.5.2 release establishes a single initial source commit after the
[history cleanup](history-cleanup.md). Publish the same tested archive on npm
and GitHub and verify both distribution channels before announcing completion.
